...
func main() {
	...
	xmlFile, err := os.Open("personeller.xml")
	if err != nil {
...
func (p personel) string() string {
	return fmt.Sprintf("\t id:%d - adi :%s -soyadi:%s  \n", p.ID, p.Adi, p.Soyadi)
}
*/
